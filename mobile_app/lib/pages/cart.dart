          ...
          children: [
                  ...
                  Row(
                    children: [
                      ...
                      _quantityButton(
                        ...
                        icon: Icons.remove,
                        onPressed: () {
                          // context .read<CartService>().increaseQty(product);
                        },
                      ),
            ...
            Column(
              ...
              children: [
                ...
                IconButton(
                  onPressed: () { context.read<CartService>().removeProduct(product); },
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                const Text( 'Subtotal', ),
                Text( 'KSh ${cart.total.toStringAsFixed(2)}', ),
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                Text( 'KSh ${cart.total.toStringAsFixed(2)}', style: Theme.of(context) .textTheme .titleLarge ?.copyWith( fontWeight: FontWeight.bold, color: Theme.of(context) .colorScheme .primary, ), ),
              ],
            ),
                          ...
                          if (!context.read<AuthService>().isLoggedIn) {
                            showDialog(
                              ...
                              builder: (_) => AlertDialog(
                                ...
                                content: const Text( "Please log in to continue with checkout.", ),
                                actions: [
                                  TextButton(
