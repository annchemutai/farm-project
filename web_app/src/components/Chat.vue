...
const suggestedChips = ref([
  { label: 'Fresh Produce', prompt: 'What fresh farm produce do you recommend this week?', icon: 'mdi-sprout' },
  { label: 'Nutrition Tips', prompt: 'What are some healthy nutrition tips for a balanced diet?', icon: 'mdi-food-apple' },
  { label: 'Seasonal Picks', prompt: 'Which farm products are in season right now?', icon: 'mdi-weather-sunny' },
  { label: 'Healthy Recipes', prompt: 'Can you suggest simple healthy recipes using local produce?', icon: 'mdi-chef-hat' }
])
